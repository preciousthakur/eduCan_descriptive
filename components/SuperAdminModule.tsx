      ...
      <Section maxWidth={"lg"} py={0}>
        ...
        >
          ...
          >
            ...
            >
              Super Admin (School Owner / Group Owner) Module
            </h1>
            <p
              ref={textRef}
              className="mt-4 md:mt-6 text-sm md:text-base leading-relaxed text-white/90"
            >
              The Super Admin (School Owner / Group Owner) Module serves as the highest level of control within the system, empowering school or group owners to oversee and manage the entire platform. It provides full authority to configure system settings, manage user roles, create and monitor institutions or branches, and ensure smooth operations across all modules. With advanced reporting, governance tools, and centralized administration, this module enables owners to maintain transparency, streamline management processes, and drive efficiency at both individual school and group levels.
            </p>
          </div>
        </div>
      </Section>
