...
const ProductOwnerModule: React.FC = () => {
      ...
      <Section maxWidth={"lg"} py={0}>
        ...
        >
          ...
          >
            ...
            >
              System / Product Owner Module
            </h1>
            <p
              ref={textRef}
              className="mt-4 md:mt-6 text-sm md:text-base leading-relaxed text-white/90"
            >
              The System / Product Owner Module provides product owners and administrators with a centralized space to manage requirements, define priorities, track progress, and oversee system operations. It enables seamless collaboration between stakeholders and development teams, ensures alignment with business goals, and offers real-time visibility into product performance. With tools for roadmap planning, governance, and decision-making, this module helps deliver efficient, user-focused, and goal-driven products.
            </p>
          </div>
        </div>
      </Section>
...
export default ProductOwnerModule;
