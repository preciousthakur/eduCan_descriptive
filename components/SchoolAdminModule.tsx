...
const SchoolAdminModule: React.FC = () => {
      ...
      <Section maxWidth={"lg"} py={0}>
        ...
        >
          ...
          >
            ...
            >
              School Admin (Branch Level) Module
            </h1>
            <p
              ref={textRef}
              className="mt-4 md:mt-6 text-sm md:text-base leading-relaxed text-white/90"
            >
              The School Admin (Branch Level) Module is designed to give branch administrators complete control over day-to-day operations at the school level. It enables them to manage staff, students, classes, and academic activities while ensuring smooth coordination between teachers, parents, and the management team. With tools for attendance, scheduling, communication, and reporting, this module streamlines branch-level administration, promotes transparency, and ensures effective execution of institutional policies and goals.
            </p>
          </div>
        </div>
      </Section>
