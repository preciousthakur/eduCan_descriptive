      ...
      <Section maxWidth={"lg"} py={0}>
        ...
        >
          ...
          >
            ...
            >
              The Parent Module provides parents with a transparent and convenient way to stay connected with their child’s academic journey. It enables parents to monitor attendance, track academic performance, view assignments, and receive important updates from the school in real time. With built-in communication tools, parents can easily interact with teachers and administrators, ensuring active involvement in their child’s education. This module strengthens the home-school partnership, promotes accountability, and supports overall student success.
            </p>
          </div>
        </div>
      </Section>
